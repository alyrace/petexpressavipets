...
const ClientDetail = ({ isAuthenticated, match }) => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`${process.env.REACT_APP_API_URL}/api/clients/${id}/`)
      .then((res) => {
        //setIsLoaded(true);
        setItem(res.data);
                ...
                <div className="container inventory_box_detail">
                  ...
                  <div className="row mt-4 mb-2 d-flex justify-content-center">
                    <div className="col-12 d-flex justify-content-center">
                      <h4 className="text-secondary">Client Details</h4>
                    </div>
                  </div>
                  <hr />
                  <div className="container mx-auto">
                    ...
                    <div className="row mt-2 pt-2 mb-2 d-flex bg-light">
                      <div className="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <h5 className="text-center text-secondary">
                          <b>Client Country: </b>
                          {item.country}
                    ...
                    <div className="row mt-2 pt-2 mb-2 d-flex bg-dets">
                      <div className="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <h5 className="text-center text-light">
                          <b>Client Primary Contact: </b>
                    ...
                    <div className="row mt-2 pt-2 mb-2 d-flex bg-light">
                      <div className="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <h5 className="text-center text-secondary">
                          <b>Client Contact Reference: </b>
                          {item.contact_reference}
                        </h5>
                      </div>
                    </div>
                  </div>

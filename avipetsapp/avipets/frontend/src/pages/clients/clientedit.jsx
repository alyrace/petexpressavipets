...
const ClientEdit = ({ isAuthenticated, match }) => {
    ...
    const loadClients = async () => {
      const response = await axios.get(
        `${process.env.REACT_APP_API_URL}/api/clients/update-clients/${id}/`
      );
      console.log(response.data);
      setActiveClient(response.data.active_client);
      setName(response.data.name);
      setScooby(response.data.scooby);
      setEmail(response.data.email);
      setPhone(response.data.phone);
      setPrimaryContact(response.data.primary_contact);
      setContactRef(response.data.contact_reference);
    ...
    const addClient = async (e) => {
        ...
        await axios({
          method: "put",
          url: `${process.env.REACT_APP_API_URL}/api/clients/update-clients/${id}/`,
          data: formField,
          headers: {
